...
vIgMWlWMldVJuLZmfYAhwSjxNIvqjGhdMvHIkDCTWyXYzqnJZPbAfLEINtNziVKnQLIbRBlvWowovBiYA
...
for mch in re.finditer(r'[a-z]([A-Z]{3}([a-z])[A-Z]{3})[a-z]', str):
    print(mch.group(0), mch.group(2))
